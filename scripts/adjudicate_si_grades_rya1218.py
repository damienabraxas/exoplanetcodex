...
cols=['line_id','species','wavelength_air_A','excitation_potential_eV','log_gf','loggf_reference','gf_tier','gf_quality_class','gf_sigma_dex','gf_source_doi','DH23_matches','physical_identity_status','solar_feature_depth','depth_ambiguous','depth_route','recipe_grade','reference_role','blend_flag','transition_match_required','gf_action']
