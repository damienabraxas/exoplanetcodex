...
# real systematic — RYA-240). Ca/Ti/Cr/Mg are neutral (ion 1); Ba is singly-ionised
# (Ba II, ion 2 — the dominant Ba stage in FGK photospheres).
...
NLTE_CORRECTION_ELEMENTS = {
    ...
    'Cr': {'ion': 1, 'grid': 'Cr_Bergemann2010_MPIA.csv',
           ...
           'mpia_species': '24.01'},
    # RYA-165 (grids vendored RYA-396): the rescoped Na/Mg/Ba leg. Li deferred
    # (RYA-103 Li 6707 CN-blend); C/O owned by nlte_cno (Amarsi 2019). Asplund
    # acceptance still gated on a curated pool (Na +0.27 / Ba +0.19 NLTE-sized;
