...
PDF file signature, not suffix: **96 PDF files, 84 distinct SHA256 hashes**.
...
| `2301.11391v1 (3).pdf` | Den Hartog et al. 2023, Si I/Si II transition probabilities | Newly added fourth byte-identical copy. |
| `jpcrd3720081501p.pdf` | Kelleher & Podobedova 2008, *Atomic Transition Probabilities of Silicon* | Complete 217-page NIST critical compilation; now held locally. |
| `aa45686-22.pdf`; `aa45686-22 (1).pdf` | Pehlivan Rhodin et al. 2024, A&A 682, A184 | Open-access Si I/Si II transition-data paper; two byte-identical copies now held. |
| `1212.2649v1.pdf`; `1212.2649v1 (1).pdf` | Bergemann et al. 2013, ApJ 764, 115 | Open-access NLTE Si J-band paper; two byte-identical copies now held. |
...
O'Brian & Lawler 1991a/b; Schulz-Gulde 1969; Blanco et al. 1995; and
Matheron et al. 2001. References to them in held documents do not establish
that their primary tables are held. The NIST compilation, Pehlivan Rhodin
2024 paper, and Bergemann et al. 2013 J-band paper are now held locally.
...
and identical-byte siblings. The newly added local PDFs are recorded; no duplicate
was deleted.
