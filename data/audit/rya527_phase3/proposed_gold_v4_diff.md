...
Verdict counts: {'PASS': 7, 'CURATION-OWED': 19}
...
| K I | 5.07 | 5.099 | gold | 5.099 | +0.000 | +0.029 | PASS | — | 5.099 | B_synth | — | ratified/dedicated channel (phase_c); two-engine = diagnostic |
| Co I | 4.94 | — | owed | 4.96 | — | +0.020 | PASS | — | 4.96 | B_synth | — | ratified/dedicated channel (phase_c); two-engine = diagnostic |
| Ba II | 2.27 | — | owed | 2.237 | — | -0.033 | PASS | — | 2.237 | B_synth | — | two-engine synthesis floor (II, B_synth) |
| N I | 7.83 | — | owed | 8.188 | — | +0.358 | CURATION-OWED | — | 8.188 | B_synth | — | ratified/dedicated channel (phase_c); two-engine = diagnostic |
...
| Sc II | 3.14 | 3.203 | gold | 3.203 | +0.000 | +0.063 | CURATION-OWED | — | 3.203 | B_synth | — | ratified/dedicated channel (phase_c); two-engine = diagnostic |
...
- `fresh_value`: 4.96
- `no_fresh_value_because`: None
- `candidates`: {'phase_c (RYA-564)': 4.96, 'RYA-643 corrected re-run': 4.96, 'fresh two-engine': 4.96}
...
- `gate3_provisional_on_artifact_age`: False
- `staleness_signals`: []
- `remedy`: none
