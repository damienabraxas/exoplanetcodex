...
def test_no_fe_ii_band_product_names_the_gerber_deck_as_its_nlte_source():
    ...
    #: 19 -> 21 (RYA-1208): both near-UV KP holdings gained the Fe II LTE-gerber leg.
    #: Same reasoning as RYA-1135 and RYA-1203 above -- these are exactly the artifacts
    #: this test exists to police, so they are swept in rather than excluded, and the
