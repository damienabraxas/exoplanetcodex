...
- **RYA-706** — SPP Appendix A mandatory: every unresolved element defends its blank with plots + measured evidence; tool ladder (EW→NLTE→synth) is the spine; solar Al re-diagnosed from the spectrum
