...
SETS: dict[str, ReferenceSet] = {
    ...
    "si-agss21": ReferenceSet(
        name="si-agss21",
        element="Si",
        path=ROOT / "data" / "reference" / "si_agss21" / "si_agss21_lines.csv",
        source=("AGSS21 Si lineage: Amarsi & Asplund 2017 Table 1 and Scott et al. 2015 "
                "selected Solar Si lines"),
        ticket="RYA-1169",
        native_line_set="si-agss21",
        wl_col="wavelength_air_A", ep_col="ep_eV", gf_col="published_loggf",
        species_col="species", gf_source_cols=("published_gf_source",),
        match_tol_A=0.05,
        tol_basis=("AGSS21 lineage wavelengths are published to 0.01 nm / 0.1 A; "
                   "use the closed half-rounding interval."),
        notes="External reference membership; gf provenance remains independent of Codex/Deep grading.",
    ),
    "si-bergemann-j": ReferenceSet(
        name="si-bergemann-j",
        element="Si",
        path=ROOT / "data" / "reference" / "si_bergemann2013" / "si_bergemann2013_j_lines.csv",
        source="Bergemann et al. 2013, ApJ 764, 115, Table 1",
        ticket="RYA-1218",
        native_line_set="si-bergemann-j",
        wl_col="wavelength_air_A", ep_col="ep_eV", gf_col="loggf",
        species_col="species", gf_source_cols=("source",),
        match_tol_A=0.01,
        tol_basis="Table 1 wavelength precision and exact canonical crossmatch audit.",
        notes="External J-band reference membership; VALD canonical gf does not become primary-lab gf.",
    ),
    "gbs": ReferenceSet(
        name="gbs",
        element="Fe",
